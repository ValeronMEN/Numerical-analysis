    ...
    public partial class NSIF : Form
    {
        ...
        private void printMainArr(double[,] mainArr, int size)
        {
            ...
            for (int j = 0; j < size + 1; j++)
            {
                if (j == 0)
                {
                    textBoxResult.Text += String.Format("{0, 18}", "x");
                }
                else if(j == 1)
                {
                    textBoxResult.Text += String.Format("{0, 20}", "y"); ;
                }
                else
                {
                    textBoxResult.Text += String.Format("{0, 30}", "d" + (j - 1) + "y");
                }
            }
            textBoxResult.Text += "\r\n";
            for (int i=0; i<size; i++)
            {
                for (int j=0; j<size+1; j++)
                {
                    textBoxResult.Text += String.Format("{0, 18}", mainArr[i, j]);
                }
                textBoxResult.Text += "\r\n";
            }
        }
